...
export default class Game extends Phaser.Scene
{
	...
	private createBoard(state: ITicTacToeState)
	{
		...
		state.board.forEach((cellState, idx) => {
			...
			switch (cellState)
			{
				case Cell.X:
				{
					this.add.rectangle(cell.x, cell.y, 10, 100, 0x00ff00)
						.setAngle(45)
					this.add.rectangle(cell.x, cell.y, 10, 100, 0xff0000)
						.setAngle(-45)
					break
				}
				...
				case Cell.O:
				{
					...
					this.add.circle(cell.x, cell.y, 40, 0xffffff)
					break
				}
			}
	...
	private handleBoardChanged(newValue: Cell, idx: number)
	{
		...
		if (cell.value !== newValue)
		{
			switch (newValue)
			{
				case Cell.X:
				{
					this.add.rectangle(cell.display.x, cell.display.y, 10, 120, 0xff0000)
						.setAngle(45)
					this.add.rectangle(cell.display.x, cell.display.y, 10, 120, 0xff0000)
						.setAngle(-45)
					break
				...
				case Cell.O:
				{
					...
					this.add.circle(cell.display.x, cell.display.y, 40, 0xffffff)
					break
				}
			}
	...
	private handlePlayerTurnChanged()
	{
